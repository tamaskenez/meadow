...
TEST(math, regspace)
{
    ...
    test_regspace(1, 1, -1, {1});
    test_regspace(1, 1, 0, {});
    test_regspace(1, 1, 1, {1});

    test_regspace(1, 2, -1, {});
    test_regspace(1, 2, 0, {});
    test_regspace(1, 2, 1, {1, 2});

    test_regspace(2, 1, -1, {2, 1});
    test_regspace(2, 1, 0, {});
    test_regspace(2, 1, 1, {});
    ...
    test_regspace(2, 1, -1, {2, 1});
    test_regspace(2, 1, 1, {});
    test_regspace(1, 1, -2, {1});
    test_regspace(1, 1, 2, {1});
    test_regspace(1, 2, -2, {});
    test_regspace(1, 2, 2, {1});
    test_regspace(2, 1, -2, {2});
    test_regspace(2, 1, 2, {});
    test_regspace(0, 3, 1, {0, 1, 2, 3});
    test_regspace(0, -3, -1, {0, -1, -2, -3});
    test_regspace(0, 4, 2, {0, 2, 4});
    test_regspace(0, -4, -2, {0, -2, -4});
    test_regspace(0, 4, 3, {0, 3});
    test_regspace(0, -4, -3, {0, -3});
}
